...
print '%f max y value' % max_value
for position, item in enumerate(y):
    if item == max_value:
        print '%f max x value' % (xa+position*delta)

print '%f min y value' % min_value
for position, item in enumerate(y):
    if item == min_value:
        print '%f min x value' % (xa+position*delta)
